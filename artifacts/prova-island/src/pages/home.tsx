...
import { Menu, Trees, Waves } from "lucide-react";
  ...
  return (
    <div className="min-h-screen w-full flex flex-col bg-background font-sans overflow-x-hidden selection:bg-primary selection:text-white">
      ...
      <main className="flex-1 flex flex-col items-center justify-center w-full relative">
        <div className="absolute inset-0 opacity-[0.03] pointer-events-none z-0" style={{ backgroundImage: 'radial-gradient(circle at 2px 2px, var(--color-primary) 1px, transparent 0)', backgroundSize: '32px 32px' }} />
        ...
        <div className="w-full max-w-[1400px] mx-auto p-4 md:p-8 lg:p-12 relative z-10 flex flex-col items-center">
          ...
          <div className="relative group w-full animate-in fade-in slide-in-from-bottom-8 duration-1000">
            {/* Playful decorative elements behind the image */}
            ...
            {/* Quick floating CTA for lower funnel (optional depending on image layout, but nice for landing pages) */}
